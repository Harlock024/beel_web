...
import { Ellipsis, Trash2, Pencil, Plus, GripVertical } from "lucide-react";
    ...
    <Draggable draggableId={column.id!} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={cn(
            "flex flex-col bg-muted/20 rounded-lg min-w-[280px] max-w-[280px] shrink-0 h-full transition-shadow",
        ...
        >
          <div className="flex items-center justify-between px-3 py-2.5 shrink-0">
            <div
              ...
              className="flex items-center gap-1 cursor-grab active:cursor-grabbing mr-1"
            >
            ...
            {(provided, snapshot) => (
              ...
              >
                {tasks.map((task, taskIndex) => (
                  <KanbanCard key={task.id} task={task} index={taskIndex} />
                ))}
