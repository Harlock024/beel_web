    ...
    <aside>
      ...
      >
        <div className="flex items-center justify-between px-3 py-1 rounded-md hover:bg-accent transition-colors cursor-pointer"> 
          <span className="text-[14px] select-none text-muted-foreground font-medium">
            Lists
          </span>
          <div className="flex items-center gap-1">
            <Button
              variant="ghost"
              size="icon"
              className="h-5 w-5 p-1 cursor-pointer hover:bg-accent transition-colors"
              onClick={(e) => {
                e.stopPropagation();
                handleAddList();
              }}
            ...
            <Button variant={"ghost"}  size="icon" className="h-5 w-5 p-1 cursor-pointer hover:bg-accent transition-colors">
              <ChevronDown 
                className={cn(
